(() => {
  const adventureName = 'Heart of Darkness';
  const moduleName = 'heart-of-darkness';
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = ["heart-of-darkness.actors"];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = ["heart-of-darkness.journals"];
  /**
   ...
   *   const macroPacks = [];
   */
  const macroPacks = ["heart-of-darkness.macros"];
  /**
   ...
   *   const playlistPacks = [];
   */
  const playlistPacks = ["heart-of-darkness.playlists"];
  /**
   ...
   */
  const additionalModulePacks = ["heart-of-darkness"];
